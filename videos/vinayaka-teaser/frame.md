...
description: >
  ...
  as bloom / panel / tile underprint, Cormorant Garamond display + Cormorant Garamond sans + JetBrains Mono data,
...
typography:
  # — reading + data ramp —
  body:    { fontFamily: "Cormorant Garamond", cqw: 0.85, weight: 400, lineHeight: 1.5, color: "ink" }
  body-lede:{ fontFamily: "Cormorant Garamond", cqw: 0.95, weight: 400, lineHeight: 1.55 }
  micro-label:{ fontFamily: "Cormorant Garamond", px: 13, weight: 600, tracking: "0.18em", upper: true }
  rail-label:{ fontFamily: "Cormorant Garamond", px: 13, weight: 600, tracking: "0.32em", upper: true }
  ...
  # — display ramp (Cormorant Garamond 400, tight, negative tracking) —
  ledger-title:{ fontFamily: "Cormorant Garamond", cqw: 1.55, weight: 400, lineHeight: 1.15 }
  strand-title:{ fontFamily: "Cormorant Garamond", cqw: 1.7, weight: 400, lineHeight: 1.1 }
  headline-sm:{ fontFamily: "Cormorant Garamond", cqw: 2.9, weight: 400, lineHeight: 1.0 }
  headline:{ fontFamily: "Cormorant Garamond", cqw: 4.6, weight: 400, lineHeight: 1.06, tracking: "-0.005em" }
  date-rail:{ fontFamily: "Cormorant Garamond", cqw: 5.0, weight: 400, lineHeight: 0.96, tracking: "-0.005em" }
  display-it:{ fontFamily: "Cormorant Garamond", cqw: 7.0, weight: 400, italic: true, lineHeight: 1.04, tracking: "-0.005em" }
  numeral-md:{ fontFamily: "Cormorant Garamond", cqw: 7.5, weight: 400, lineHeight: 0.92, tracking: "-0.01em" }
  display:{ fontFamily: "Cormorant Garamond", cqw: 14.6, weight: 400, lineHeight: 0.86, tracking: "-0.018em" }
  numeral-jumbo:{ fontFamily: "Cormorant Garamond", cqw: 28.0, weight: 400, lineHeight: 0.84, tracking: "-0.04em" }
...
- **Fonts** — already set to **Cormorant Garamond** (display) / **Outfit** (body); ignore any preset font name lingering in prose.
...
The voice is three faces in rigid roles: **Cormorant Garamond** (weight 400, tight line-height,
negative tracking) carries every display, numeral, and quote from 40px to 720px+; **Cormorant Garamond** carries
...
- **Cormorant Garamond 400** display (tight, negative-tracked); **Cormorant Garamond** body + micro-labels; **JetBrains Mono** data.
...
- **Squint** — one Cormorant Garamond moment dominates at 3–6× its neighbor; the sun bloom centers the eye.
...
Two ramps. The **reading/data ramp** (Cormorant Garamond body 0.85cqw ink, micro-labels in px, JetBrains Mono
data) carries copy + chrome; the **display ramp** (Cormorant Garamond `ledger-title` 1.55cqw →
...
- **Cormorant Garamond is weight 400 only** (its contrast is the weight signal), tight line-height (0.84–1.06), negative tracking; **micro-labels uppercase Cormorant Garamond 600, ≥0.16em**; **mono for all numerals/dates**. No bold serif, no second text color, no mono in body/display.
...
headline-sm. **Focal** a single huge Cormorant Garamond `numeral-jumbo` (≈28cqw) dominating, with a
...
**Focal** a 2-line Cormorant Garamond **italic** `display-it` quote in ink, centered, under an
...
yellow-panel, micro-label, headline. **Focal** an Cormorant Garamond `headline` in ink sitting **on
...
- Set every line in **ink**; use **Cormorant Garamond 400** (tight, negative-tracked) for display, **Cormorant Garamond** body, **JetBrains Mono** for all numerals/dates.
- Make every separator a **1px ink hairline** (soft variant for dense rows); flood a **yellow panel** for poster moments (ink on top).
- Keep micro-labels **uppercase Cormorant Garamond 600, 0.16–0.32em**; pin the **pagenum** bottom-right.
...
- No second text color; no bold Cormorant Garamond; no inverted ink grounds.
...
- **Type** — Cormorant Garamond 400 tight negative-tracked, fit-to-measure; micro-labels uppercase 0.16em+; mono numerals; ≥1.4cqw floor.
...
- **Cormorant Garamond + Cormorant Garamond + JetBrains Mono via Google Fonts.** CJK: Smiley Sans (display) / Noto Serif SC (body) / Noto Sans SC (labels); italic serif and mono tabular figures have no exact Hanzi equal — keep ledger dates Latin.
