(function () {
  ...
  function setupGestures() {
    ...
    target.addEventListener("pointerdown", (e) => {
      if (e.target.closest("button") || e.target.closest("a") || e.target.closest(".ar-prompt-card")) return;
      isDragging = true;
    ...
    target.addEventListener("wheel", (e) => {
      if (e.target.closest(".ar-prompt-card")) return;
      e.preventDefault();
  ...
  // ==========================================
  // 6. Interactive Temple Bell, Sound & Autoplay
  // ==========================================
  function ringBell() {
    if (hangingBell) {
