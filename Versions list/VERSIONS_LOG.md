...
| :--- | :--- | :--- | :--- |
| **v2.0.0_revert_ar_experience_clean** | 2026-08-30 04:49 | Removed all AR add-ons and restored clean, standard responsive invitation website. | index.html, css/experience.css, js/experience.js, js/audio.js, js/countdown.js, Qr Code.jpeg, rame-14-donation-qr.jpeg |
...
### 2.0.0_revert_ar_experience_clean (Latest)
- **AR Removal:** Completely removed r.html, css/ar.css, js/ar.js, and ssets/ar-invitation-qr.png.
- **Pure Web Experience:** Cleaned all listeners and preserved all standard website features including dynamic Auto Play, Donation Modal popup, and devotional music.
